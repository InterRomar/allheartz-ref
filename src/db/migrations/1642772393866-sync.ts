...
export class sync1642772393866 implements MigrationInterface {
  name = 'sync1642772393866';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TYPE "public"."region_movement_type_enum" AS ENUM(\'rom\', \'dynamic\', \'both\')');
    await queryRunner.query('CREATE TABLE "region" ("region_id" SERIAL NOT NULL, "joint" "public"."region_joint_enum" NOT NULL DEFAULT \'knee\', "side" "public"."region_side_enum" NOT NULL, "movement_type" "public"."region_movement_type_enum" NOT NULL, "alignment_img_link" text, "example_video_link" text NOT NULL, "default_post_exam_survey_type" text, "default_recovery_plan" text, CONSTRAINT "PK_54bf2818af7cc627f2f81f091a6" PRIMARY KEY ("region_id"))');
    ...
    await queryRunner.query('CREATE TABLE "exam" ("exam_id" SERIAL NOT NULL, "video_link" text NOT NULL, "marked_up_video_link" text, "paint_scale_value" integer NOT NULL, "paint_scale_img_link" text, "outcome_score" integer, "patient_region_id" integer NOT NULL, CONSTRAINT "PK_9c1235b8acf443cd1e9982eb112" PRIMARY KEY ("exam_id"))');
    await queryRunner.query('CREATE TABLE "recovery_plan" ("recovery_plan_id" SERIAL NOT NULL, "duration" text NOT NULL, "exam_cadence" integer NOT NULL, "region_id" integer NOT NULL, CONSTRAINT "PK_bfa503518e783e1550e45365b5c" PRIMARY KEY ("recovery_plan_id"))');
    await queryRunner.query('CREATE TYPE "public"."goal_weight_option_enum" AS ENUM(\'none\', \'WBAT\', \'TDWB\')');
    await queryRunner.query('CREATE TABLE "goal" ("goal_id" SERIAL NOT NULL, "duration" text, "weight_option" "public"."goal_weight_option_enum" NOT NULL DEFAULT \'none\', "rom" integer NOT NULL, "recovery_plan_id" integer NOT NULL, "patient_region_id" integer NOT NULL, CONSTRAINT "PK_2d199148876db1d4ff34ac2b0d5" PRIMARY KEY ("goal_id"))');
    ...
    await queryRunner.query('ALTER TABLE "recovery_plan" ADD CONSTRAINT "fk_recovery_plan<=region.region_idregion_id" FOREIGN KEY ("region_id") REFERENCES "region"("region_id") ON DELETE SET NULL ON UPDATE NO ACTION');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "recovery_plan" DROP CONSTRAINT "fk_recovery_plan<=region.region_idregion_id"');
    ...
    await queryRunner.query('DROP TYPE "public"."region_movement_type_enum"');
