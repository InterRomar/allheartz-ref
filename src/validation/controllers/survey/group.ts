...
const createOne = {
  body: {
    name: yup.string().strict().required(errorMessages.NAME_MISSED),
    description: yup.string().strict(),
    surveyTopicId: yup.number().strict().required(errorMessages.FIELD_IS_REQUIRED),
  },
};
...
const updateOne = {
  ...
  body: {
    ...
    description: yup.string().strict(),
    surveyTopicId: yup.number().strict(),
  },
};
